# iot-webapp-2025
<p>IoT 개발자 <a href="https://dotnet.microsoft.com/ko-kr/apps/aspnet" target="_blank" style="color:red;">ASP.NET Core</a> 학습 리포지토리</p>
...
- WPF앱 API 사용 - 데이터포털로 부산맛집정보앱, 영화즐겨찾기와 동일(GET메서드만 사용)
    ...
    <img src="./image/web32.png" width="600">
...
- CORS Policy Block : Cross-Origin Resource Sharing. 다른 출처 리소스 접근허용 보안 메커니즘
    ...
    <img src="./image/web33.png" width="400">
...
- 실행화면
    ...
    <img src="./image/web34.png" width="600">
