...
namespace WebApiApp03.Controllers
{
    ...
    public class IoTDatasController : ControllerBase
    {
        ...
        // GET: api/IoTDatas
        [HttpGet]
        //public async Task<ActionResult<IEnumerable<iot_datas>>> Getiot_datas()
        //{
        ...
        //[HttpPut("{id}")]
        //public async Task<IActionResult> PutIoTDatas(int id, iot_datas iot_datas)
        //{
        //    if (id != iot_datas.Id)
        //    {
        //        return BadRequest();
        ...
        //// To protect from overposting attacks, see https://go.microsoft.com/fwlink/?linkid=2123754
        //[HttpPost]
        //public async Task<ActionResult<iot_datas>> PostIoTDatas(iot_datas iot_datas)
        //{
