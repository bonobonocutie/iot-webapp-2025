...
cursor = conn.cursor() # DB연결 생성, 커서 생성

#  입력값 파라미터
start_date = datetime(1997, 1, 20) # 10,000일전 기준일
records_per_day = 100
total_days = 10000
...
for day in range(total_days): # 10000일 반복
    ...
    for i in range(records_per_day): # 100번 반복
        ...
        temp = round(random.uniform(19.0, 28.0), 1) # 19 ~ 28도 사이의 온도 랜덤, 소수점 1번째에서 반올림
        humid = round(random.uniform(30.0, 60.0), 2) # 30 ~ 60% 사이의 습도 랜덤, 소수점 2번째에서 반올림
