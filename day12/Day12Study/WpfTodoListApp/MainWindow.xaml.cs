...
namespace WpfTodoListApp
{
    ...
    public partial class MainWindow : MetroWindow
    {
        ...
        private void MetroWindow_Loaded(object sender, System.Windows.RoutedEventArgs e)
        {
            ...
            // RestAPI 호출 준비
            client.BaseAddress = new System.Uri("http://localhost:5152"); // API 서버 URL
        ...
        // async 시 Task가 리턴값이지만 버튼클릭이벤트메서드와 연결 시는 Task -> void로 변경해줘야 연결 가능
        ...
        private async void GrdTodoItems_SelectionChanged(object sender, System.Windows.Controls.SelectionChangedEventArgs e)
        {
            try
            {
                ...
                //await this.ShowMessageAsync("클릭", Id.TString());
